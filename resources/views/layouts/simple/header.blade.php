    ...
    <div class="nav-right col-xxl-7 col-xl-6 col-md-7 col-8 pull-right right-header p-0 ms-auto">
      <ul class="nav-menus">
        ...
        <li class="profile-nav pe-0 py-0">
          <div class="media profile-media"><img class="b-r-10" src="{{ session('u_data')->user_profile_img ? asset(session('u_data')->user_profile_img) : asset('assets/images/dashboard/profile.png') }}" alt="">
