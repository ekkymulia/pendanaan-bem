                                                    ...
                                                    <table class="display tbl-riil calc-price" id="basic-1-2">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input class="form-control" id="hargaSatuan" type="text" placeholder="Harga Satuan" autocomplete="off" name="riil_hargasatuan[]" value="{{ $danaRiil->harga_satuan }}" {{ session('u_data')->user_role != '3' ? 'disabled' : '' }}>
                                                                </td>
                                                                <td>
